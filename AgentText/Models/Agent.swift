...
struct Agent: Identifiable, Codable {
    ...
    let apiUrl: String // Hosted API endpoint for the agent
    let integrations: [String] // List of enabled integrations (e.g., "google_calendar")
    ...
    init(id: String, data: [String: Any]) {
        ...
        self.integrations = data["integrations"] as? [String] ?? []
